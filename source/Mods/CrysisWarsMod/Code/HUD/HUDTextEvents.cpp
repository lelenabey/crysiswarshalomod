...
{
	const wchar_t* localizedText = L"";
	localizedText = LocalizeWithParams(msg, false);

	m_animMPMessages.Invoke("addFunLog", localizedText);
}

void CHUD::DisplayObjectivesMessage(const char* msg, const char* name, bool enemy)
{
	const wchar_t* localizedText = L"";
	localizedText = LocalizeWithParams(msg, false);
...
void CHUD::DisplayGameStartMessage(const char* label, const char* seconds, const char* scoreLimit, const char* timeLimit)
{
	const wchar_t* localizedText = L"";
